...
CREATE TABLE `item` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_iem_permission_groups_idx` (`permission_group_id`),
  CONSTRAINT `fk_iem_permission_groups` FOREIGN KEY (`permission_group_id`) REFERENCES `permission_groups` (`id`)
...
-- Dump completed on 2023-10-28 18:49:08
